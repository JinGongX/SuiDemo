...
function dialogResultCallback(id, data, isJSON) {
  let resolvers = getAndDeleteResponse2(id);
  if (!resolvers) {
    return;
  }
  if (isJSON) {
...
function dialogErrorCallback(id, message) {
  var _a2;
  (_a2 = getAndDeleteResponse2(id)) === null || _a2 === void 0 ? void 0 : _a2.reject(new window.Error(message));
}
...
function dialog(type, options = {}) {
  ...
  return new Promise((resolve, reject) => {
    ...
    call7(type, Object.assign({ "dialog-id": id }, options)).catch((err) => {
      dialogResponses.delete(id);
      reject(err);
    });
  });
